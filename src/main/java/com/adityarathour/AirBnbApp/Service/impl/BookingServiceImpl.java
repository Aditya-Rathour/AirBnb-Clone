...
import com.adityarathour.AirbnbApp.Entity.*;
import com.adityarathour.AirbnbApp.Enum.BookingStatus;
import com.adityarathour.AirbnbApp.Repository.*;
import com.adityarathour.AirbnbApp.Service.BookingService;

import com.adityarathour.AirbnbApp.Service.CheckoutService;
...
import com.adityarathour.AirbnbApp.strategy.PricingService;
...
public class BookingServiceImpl implements BookingService {
    ...
    public boolean hasBookingExpired(Booking booking) {
        return booking.getCreatedAt().plusSeconds(60*10).isBefore(LocalDateTime.now());
    }
}
